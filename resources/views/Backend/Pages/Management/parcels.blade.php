            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Parcel Details</h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title flex-grow-1 mb-0">Parcel #VL2667</h5>
                                <div class="flex-shrink-0">
                                    <a href="{{url('apps-invoices-details.html')}}" class="btn btn-primary btn-sm"><i
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-15"><a href="{{url('apps-ecommerce-product-details.html')}}"
                                                                class="link-primary">Parcel Title</a></h5>
                                            ...
                                            <td colspan="2" class="fw-medium p-0">
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Discount <span class="text-muted">Cupon</span> : :
                                                            </td>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center">
                                <h5 class="card-title flex-grow-1 mb-0">Parcel Status</h5>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item border-0">
                                        <div class="accordion-header" id="headingOne">
                                            <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="fs-15 mb-0 fw-semibold">Parcel Placed - <span
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body ms-2 ps-5 pt-0">
                                                <h6 class="mb-1">An parcel has been placed.</h6>
                                                <p class="text-muted">Wed, 15 Dec 2021 - 05:34PM</p>

                                                <h6 class="mb-1">Seller has processed your parcel.</h6>
                                    ...
                                    <div class="accordion-item border-0">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body ms-2 ps-5 pt-0">
                                                <h6 class="mb-1">Your Item has been picked up by SohagTech Paribahan</h6>
                                    ...
                                    <div class="accordion-item border-0">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body ms-2 ps-5 pt-0">
                                                <h6 class="fs-14">SohagTech Logistics - MFDS1400457854</h6>
                                        ...
                                        <div class="accordion-header" id="headingFive">
                                            <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="fs-14 mb-0 fw-semibold">Parcel Shifed</h6>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h5 class="fs-16 mt-2">STP Logistics</h5>
