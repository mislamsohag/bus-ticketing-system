                            ...
                            <form>
                                <div class="row g-3">
                                    ...
                                    <div class="col-xxl-2 col-sm-6">
                                        <div>
                                            <input type="date" class="date form-control" data-provider="flatpickr"
                                ...
                                <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active All py-3" data-bs-toggle="tab" id="All" href="#home1"
                                            ...
                                            <i class="ri-store-2-fill me-1 align-bottom"></i> All Tickets
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link py-3 Pickups" data-bs-toggle="tab" id="Pickups"
                                            ...
                                            <i class="ri-truck-line me-1 align-bottom"></i> In Progress <span
                                    ...
                                    <table class="table table-nowrap align-middle" id="orderTable">
                                        <thead class="text-muted table-light">
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="sort" data-sort="customer_name">Passenger</th>
                                                <th class="sort" data-sort="product_name">Ticket</th>
                                                <th class="sort" data-sort="date">Travel Date</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                                ...
                                                <td class="product_name">STP-45454</td>
